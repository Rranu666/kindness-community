...
import { Calendar, Clock, Award, TrendingUp, CheckCircle2, AlertCircle, ArrowLeft } from "lucide-react";
...
export default function VolunteerPersonalDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      {/* Top nav bar */}
      <div className="bg-white border-b border-slate-200 px-4 md:px-8 py-3 flex items-center gap-3 sticky top-0 z-10 shadow-sm">
        <button
          onClick={() => navigate("/")}
        ...
        <span className="text-slate-500 text-sm">Volunteer Dashboard</span>
      </div>
