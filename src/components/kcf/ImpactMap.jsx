...
const locations = [
  ...
  },
  {
    ...
    color: "#6366f1",
    tag: "Operations",
    impact: "India operations hub driving Service Connect Pro rollout and digital infrastructure development across the region.",
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <p className="mt-5 text-white/40 max-w-xl mx-auto text-base leading-relaxed">
            From our headquarters in Newport Beach to communities across India, our initiatives span continents with purpose.
          </p>
        </motion.div>
