...
export default function PartnerSection() {
  ...
  return (
    <section id="partners" className="py-24 lg:py-32 bg-white" ref={ref}>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-rose-50 border border-rose-100 mb-6">
              ...
              <span className="text-rose-500 text-xs font-bold tracking-widest uppercase">Partner With Us</span>
            </div>
            ...
            <button
              ...
              className="group inline-flex items-center gap-3 px-8 py-4 bg-[#0d1b2a] hover:bg-[#162435] text-white font-semibold rounded-2xl transition-all duration-300 shadow-lg shadow-slate-200"
            >
              Contact Us
          ...
          >
            {partners.map((p, i) => (
              <motion.div
                ...
                className="flex items-center gap-5 p-5 rounded-2xl bg-slate-50 border border-slate-100 hover:border-rose-200 hover:bg-rose-50/30 hover:shadow-sm transition-all duration-300"
              >
                ...
                <span className="text-[#0d1b2a] font-semibold">{p.label}</span>
              </motion.div>
            ))}
          </motion.div>
        </div>
